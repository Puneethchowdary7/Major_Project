...
def accept_appointment(request, pk):
    ...
    try:
        send_mail(subject, plain_message, 'bnpuneeth77@gmail.com',  [patient_email], html_message=html_message, fail_silently=False)
...
#This is used to give reviews for the doctors by the patients
@csrf_exempt
@login_required(login_url="login")
